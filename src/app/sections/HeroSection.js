...
const HeroSection = () => {
  const handleDownloadResume = () => {
    ...
    link.href = "/Samee-Ur-Rehman LatestResume.pdf"; // Path to the file in the public folder
    link.download = "Samee_Ur_Rehman_Resume.pdf"; // Set the desired file name
    link.click();
  };
  return (
      ...
      <div className="flex flex-col justify-center w-[60%] gap-8 max-[800px]:w-[100%]">
        ...
        <div>
          <p className="text-3xl text-[#c4c4c4] max-[550px]:text-2xl max-[400px]:text-xl">
            ...
            with 2 years of experience creating user friendly websites.
          </p>
        </div>
        <div>
          <GreenButton
